               ...
               <div class="col-lg-6 col-md-6 col-12 left-section">
                 <div class="p-2">
                     <div class="left-header-text mt-4">
                         <h2 class="p-1 text-center fw-bold">{{ $content->company_name }}</h2>
                     </div>
                     <div class="left-section-img d-flex justify-content-center">
                       <img src="{{asset('image/epson-ecotank-l15150-a3-wi-fi-duplex-multifunction-ink-tank-printer.Epson L15150.1.jpg')}}" alt="login image">
                     </div>
