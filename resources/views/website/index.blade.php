...
@section('website-content')
    ...
    <div class="bg-gray content p-tb-30" id="bodycontent">
                ...
                <div class="col-lg-9 col-md-12" id="home_slider_div">
                    <div class="home-slider">
                                    ...
                                    <div class="slide">
                                        <a href="{{ $bannerItem->offer_link ?? '#' }}">
                                            <img alt="{{ $bannerItem->title ?? 'Banner' }}" class="img-responsive"
                                                src="{{ asset($bannerItem->image) }}" style="width:100%; height:auto;" />
                                        </a>
                                    </div>
                                @endif
                            @endforeach
                        @else
                            ...
                            <div class="slide">
                                <a href="#">
                                    <img alt="Default Banner" class="img-responsive"
                                        src="{{asset('/')}}image/1_17181801639038.jpg" style="width:100%; height:auto;" />
                                </a>
                            </div>
                            <div class="slide">
                                <a href="#">
                                    <img alt="Default Banner" class="img-responsive"
                                        src="{{asset('/')}}image/2_17181801721293.jpg" style="width:100%; height:auto;" />
                                </a>
                            </div>
                        @endif
                    </div>
                    ...
                    <form action="https://www.corporatetechbd.com/compare_product" class="form-cmpr" method="post">
                        ...
                        <div class="mdl-compare" style="background-color: #3321c8;">
                            ...
                            <div class="cmpr-field" id="cmpr-field-1">
                                <input class="cmpr-product2" id="product_search_1" placeholder="Search and Select Product"
                                    required="" type="text" />
                            ...
                            <div class="cmpr-field" id="cmpr-field-2">
                                <input class="cmpr-product1" id="product_search_2" placeholder="Search and Select Product"
                                    required="" type="text" />
        ...
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 padding-responsive-left">
                    <a class="c-card ws-box" href="form.html">
                        ...
                        <div>
                            ...
                            <p class="m-hide">Find Your Product </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="sliding_text_wrap" style="background: #3321c8;color:white;font-weight:bold;">
                <marquee direction="left">Welcome to DataScape-IT-Limited – Your Trusted Partner for Reliable ICT
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade modal-xxl" id="buyNowModal" tabindex="-1">
